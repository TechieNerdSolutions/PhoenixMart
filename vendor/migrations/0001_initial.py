    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to=vendor.models.user_directory_path)),
                ('cover_image', models.ImageField(default='blank', upload_to=vendor.models.user_directory_path)),
                ...
                ('social_media_handles', models.CharField(blank=True, max_length=200, null=True)),
                ('logo', models.ImageField(blank=True, null=True, upload_to=vendor.models.user_directory_path)),
                ('average_rating', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
                ('slug', models.SlugField(max_length=255, unique=True)),
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vendor_address', to='core.address')),
                ('contact_emergency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contact_emergency_address', to='core.address')),
